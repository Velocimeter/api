...
from multicall.constants import (
    GAS_LIMIT, MULTICALL3_ADDRESSES, w3)
...
PULSECHAIN_MULTICALL3_ADDRESS: Dict[int, str] = {
    369: '0xca11bde05977b3631167028862be2a173976ca11',
}

UPDATED_MULTICALL3_ADDRESSES = {
    **MULTICALL3_ADDRESSES, **PULSECHAIN_MULTICALL3_ADDRESS}


class PulseMulticall(Multicall):
    def __init__(
        self,
        calls: List[Call],
        ...
        if require_success is True:
            multicall_map = MULTICALL3_ADDRESSES if self.chainid in MULTICALL3_ADDRESSES else UPDATED_MULTICALL3_ADDRESSES
